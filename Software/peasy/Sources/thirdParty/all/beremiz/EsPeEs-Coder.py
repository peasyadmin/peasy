...
if sys.platform == 'win32':
    paths = ''
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'bin;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'lib;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'crosstool' + os.sep + 'i686-unknown-linux-gnu' + os.sep + 'gcc-2.95.3-glibc-2.1.3' + os.sep + 'bin;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'crosstool' + os.sep + 'i686-unknown-linux-gnu' + os.sep + 'gcc-2.95.3-glibc-2.1.3' + os.sep + 'lib;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'crosstool' + os.sep + 'x86_64-unknown-linux-gnu' + os.sep + 'gcc-3.3.3-glibc-2.3.2' + os.sep + 'bin;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'crosstool' + os.sep + 'x86_64-unknown-linux-gnu' + os.sep + 'gcc-3.3.3-glibc-2.3.2' + os.sep + 'lib;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'cross' + os.sep + 'x-tools' + os.sep + 'arm-unknown-linux-gnueabi' + os.sep + 'bin;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Linux' + os.sep + 'opt' + os.sep + 'cross' + os.sep + 'x-tools' + os.sep + 'arm-unknown-linux-gnueabi' + os.sep + 'lib;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Windows' + os.sep + 'bin;'
    paths += os.getcwd() + os.sep + 'Compiler' + os.sep + 'Windows' + os.sep + 'lib;'
    os.putenv('PATH', paths + os.environ['PATH'])
